import { Children, LayerSettings, PluginPayload, CodeGenerationContext } from "../types";
/**
...
export interface INode<TSettings extends LayerSettings = LayerSettings> {
     ...
     */
    getTranslationCode(settings: TSettings, children?: Children, context?: CodeGenerationContext): string;
    /**
 ...
 */
export interface IUniversalNode<TSettings extends LayerSettings = LayerSettings> extends INode<TSettings>, IPlugin {
    /**
