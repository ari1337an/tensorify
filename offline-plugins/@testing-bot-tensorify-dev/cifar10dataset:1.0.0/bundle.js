...
print(\${variableName})\`;
  ...
  __export(index_exports, {
    default: () => Cifar10datasetPlugin
  });
  init_define_process();
  var import_sdk = __toESM(require_dist());
  var _Cifar10datasetPlugin = class _Cifar10datasetPlugin extends import_sdk.TensorifyPlugin {
    constructor() {
      const definition = {
        // Visual Configuration
        visual: {
    ...
    getTranslationCode(settings, children, context) {
      ...
      const variableName = settings.datasetVarName || settings.variableName || "cifar10_dataset";
  ...
  __name(_Cifar10datasetPlugin, "Cifar10datasetPlugin");
  var Cifar10datasetPlugin = _Cifar10datasetPlugin;
