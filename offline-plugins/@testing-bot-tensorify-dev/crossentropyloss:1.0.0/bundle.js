...
print(\${variableName})\`;
  ...
  __export(index_exports, {
    default: () => CrossentropylossPlugin
  });
  init_define_process();
  var import_sdk = __toESM(require_dist());
  var _CrossentropylossPlugin = class _CrossentropylossPlugin extends import_sdk.TensorifyPlugin {
    constructor() {
      const definition = {
        // Visual Configuration
        nodeType: import_sdk.NodeType.LOSS_FUNCTION,
        visual: {
        ...
        outputHandles: [
          import_sdk.NextNodeAsOutput,
          {
            ...
            dataType: import_sdk.NodeType.LOSS_FUNCTION,
        ...
        settingsFields: [
          ...
          },
          {
            ...
            defaultValue: "",
            required: false,
            description: "Variable name for class weights (e.g., 'class_weights'). Leave empty for None"
          },
          {
            key: "ignore_index",
            label: "Ignore Index",
          ...
          },
          {
            key: "reduction",
            label: "Reduction",
            type: import_sdk.SettingsUIType.DROPDOWN,
            dataType: import_sdk.SettingsDataType.STRING,
            defaultValue: "mean",
            required: false,
          ...
          },
          {
            ...
            defaultValue: 0,
            required: false,
            description: "A float in [0.0, 1.0]. Specifies the amount of smoothing when computing the loss",
            validation: {
              min: 0,
              max: 1
            }
          ...
          variables: [
            {
              ...
              isOnByDefault: true,
              type: import_sdk.NodeType.LOSS_FUNCTION
            }
          ],
    ...
    getTranslationCode(settings, children, context) {
      ...
      const variableName = settings.lossVarName || settings.variableName || "criterion";
      ...
      const labelSmoothing = settings.label_smoothing ?? 0;
      const params = [];
      if (weightInput) {
  ...
  __name(_CrossentropylossPlugin, "CrossentropylossPlugin");
  var CrossentropylossPlugin = _CrossentropylossPlugin;
