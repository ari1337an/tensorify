...
```typescript
import dataloaderLinearLayer from './dist/index.js';

// Create a linear layer instance
const linearLayer = new dataloaderLinearLayer();
...
# dataloader Linear Layer: 784 -> 128 features
dataloader_linear_layer = nn.Linear(784, 128, bias=True)
```
