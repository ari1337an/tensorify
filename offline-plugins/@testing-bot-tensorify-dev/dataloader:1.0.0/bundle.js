...
print(\${variableName})\`;
  ...
  __export(index_exports, {
    default: () => DataloaderPlugin
  });
  init_define_process();
  var import_sdk = __toESM(require_dist());
  var _DataloaderPlugin = class _DataloaderPlugin extends import_sdk.TensorifyPlugin {
    constructor() {
      const definition = {
        // Visual Configuration
        visual: {
        ...
        settingsFields: [
          ...
          },
          {
            ...
            defaultValue: false,
            required: false,
            description: "If True, copies Tensors into CUDA pinned memory before returning"
          },
          {
            key: "drop_last",
            label: "Drop Last",
          ...
          },
          {
            ...
            defaultValue: false,
            required: false,
            description: "If True, workers will not shut down after dataset is consumed"
          }
        ],
        // Plugin Metadata
        emits: {
          variables: [
            {
              ...
              isOnByDefault: true,
              type: import_sdk.NodeType.DATALOADER
            }
          ],
    ...
    getTranslationCode(settings, children, context) {
      ...
      const variableName = settings.dataloaderVarName || settings.variableName || "dataloader";
      ...
      const datasetInput = context ? this.getInput(context, 1) : null;
  ...
  __name(_DataloaderPlugin, "DataloaderPlugin");
  var DataloaderPlugin = _DataloaderPlugin;
