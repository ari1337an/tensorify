...
```typescript
import mnistLinearLayer from './dist/index.js';

// Create a linear layer instance
const linearLayer = new mnistLinearLayer();
...
# mnist Linear Layer: 784 -> 128 features
mnist_linear_layer = nn.Linear(784, 128, bias=True)
```
