...
print(\${variableName})\`;
  ...
  var _ReluPlugin = class _ReluPlugin extends import_sdk.TensorifyPlugin {
    constructor() {
      const definition = {
        visual: {
          ...
          icons: {
            primary: { type: import_sdk.IconType.LUCIDE, value: "activity" },
            secondary: [],
            showIconBackground: true,
            iconSize: "medium"
          },
    ...
    getTranslationCode(settings, _children, _context) {
      const variableName = settings.reluVarName || settings.variableName || "relu";
      const shouldEmit = Boolean(settings.emitReluVar);
  ...
  __name(_ReluPlugin, "ReluPlugin");
  var ReluPlugin = _ReluPlugin;
