...
var PluginBundle = (() => {
  ...
  var require_visual = __commonJS({
    "node_modules/@tensorify.io/sdk/dist/types/visual.js"(exports) {
      ...
      var HandleViewType;
      (function(HandleViewType2) {
        HandleViewType2["DEFAULT"] = "default";
        HandleViewType2["VERTICAL_BOX"] = "verticalBox";
        HandleViewType2["CIRCLE_LG"] = "circle-lg";
        HandleViewType2["DIAMOND"] = "diamond";
        HandleViewType2["SQUARE"] = "square";
        HandleViewType2["TRIANGLE"] = "triangle";
      })(HandleViewType || (exports.HandleViewType = HandleViewType = {}));
      var HandlePosition;
      (function(HandlePosition2) {
        HandlePosition2["TOP"] = "top";
        HandlePosition2["TOP_RIGHT"] = "top-right";
        HandlePosition2["RIGHT"] = "right";
        HandlePosition2["BOTTOM_RIGHT"] = "bottom-right";
        HandlePosition2["BOTTOM"] = "bottom";
        HandlePosition2["BOTTOM_LEFT"] = "bottom-left";
        HandlePosition2["LEFT"] = "left";
        HandlePosition2["TOP_LEFT"] = "top-left";
      })(HandlePosition || (exports.HandlePosition = HandlePosition = {}));
      var EdgeType;
      (function(EdgeType2) {
        EdgeType2["DEFAULT"] = "default";
        EdgeType2["SOLID"] = "solid";
        EdgeType2["DOTTED"] = "dotted";
        EdgeType2["DASHED"] = "dashed";
        EdgeType2["ACCENT"] = "accent";
        EdgeType2["MUTED"] = "muted";
        EdgeType2["SUCCESS"] = "success";
        EdgeType2["WARNING"] = "warning";
        EdgeType2["ERROR"] = "error";
...
print(\${variableName})\`;
  ...
  __export(index_exports, {
    default: () => SequencePlugin
  });
  init_define_process();
  var import_sdk = __toESM(require_dist());
  var _SequencePlugin = class _SequencePlugin extends import_sdk.TensorifyPlugin {
    constructor() {
      const definition = {
        visual: {
          ...
          icons: {
            primary: { type: import_sdk.IconType.LUCIDE, value: "list" },
            secondary: [],
            showIconBackground: true,
            iconSize: "medium"
          },
        ...
        settingsFields: [
          ...
          },
          {
            ...
            defaultValue: true,
            required: true,
            description: "Controls emission of the Sequential container variable"
          },
          {
            key: "itemsCount",
    ...
    getTranslationCode(settings, children, _context) {
      const variableName = settings.sequenceVarName || settings.variableName || "seq";
      const shouldEmit = Boolean(settings.emitSequenceVar);
      const indent = "  ";
      const indentBlock = /* @__PURE__ */ __name((s) => s.split("\n").map((line) => line.trim().length ? indent + line : line).join("\n"), "indentBlock");
      const parts = (children || []).map((c) => (c.code || "").trim()).filter(Boolean).map((p) => indentBlock(p));
...
${inner}
  ...
  __name(_SequencePlugin, "SequencePlugin");
  var SequencePlugin = _SequencePlugin;
