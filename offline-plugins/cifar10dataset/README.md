...
```typescript
import cifar10datasetLinearLayer from './dist/index.js';

// Create a linear layer instance
const linearLayer = new cifar10datasetLinearLayer();
...
# cifar10dataset Linear Layer: 784 -> 128 features
cifar10dataset_linear_layer = nn.Linear(784, 128, bias=True)
```
