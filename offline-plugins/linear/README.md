...
```typescript
import linearLinearLayer from './dist/index.js';

// Create a linear layer instance
const linearLayer = new linearLinearLayer();
...
# linear Linear Layer: 784 -> 128 features
linear_linear_layer = nn.Linear(784, 128, bias=True)
```
