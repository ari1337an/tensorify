 ...
 *
 * A dataset plugin for loading the MNIST dataset using torchvision.
 * Acts as a variable provider that can emit dataset variables.
 */
export default class MnistPlugin extends TensorifyPlugin {
  constructor() {
  ...
  public getTranslationCode(
    ...
    const variableName =
      settings.datasetVarName || settings.variableName || "mnist_dataset";
