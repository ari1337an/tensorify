...
Multi-epoch training orchestrator plugin
...
```typescript
import multi-epoch-trainerLinearLayer from './dist/index.js';

// Create a linear layer instance
const linearLayer = new multi-epoch-trainerLinearLayer();
...
# multi-epoch-trainer Linear Layer: 784 -> 128 features
multi-epoch-trainer_linear_layer = nn.Linear(784, 128, bias=True)
```
