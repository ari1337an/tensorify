...
```typescript
import reluLinearLayer from './dist/index.js';

// Create a linear layer instance
const linearLayer = new reluLinearLayer();
...
# relu Linear Layer: 784 -> 128 features
relu_linear_layer = nn.Linear(784, 128, bias=True)
```
