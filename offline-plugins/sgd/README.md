...
```typescript
import sgdLinearLayer from './dist/index.js';

// Create a linear layer instance
const linearLayer = new sgdLinearLayer();
...
# sgd Linear Layer: 784 -> 128 features
sgd_linear_layer = nn.Linear(784, 128, bias=True)
```
