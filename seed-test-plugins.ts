 ...
 *
 * Run with: npx ts-node seed-test-plugins.ts
 */

import { promises as fs } from "fs";
import db from "./services/app.tensorify.io/src/server/database/db";
 ...
 */
async function insertTestPlugin(testCase: TestCase) {
...
export { parseTestCases, insertTestPlugin, verifyWorkflow };
