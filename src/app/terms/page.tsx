    ...
    <div className="container mx-auto px-4 md:px-6 py-12">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose dark:prose-invert max-w-none">
          ...
          <div className="mb-8">
            <p className="mb-4">
              The website located at <a href="https://tensorify.io" className="text-primary hover:underline">https://tensorify.io</a> and all of its subdomains, including but not limited to <a href="https://app.tensorify.io" className="text-primary hover:underline">app.tensorify.io</a>, <a href="https://mockapi.tensorify.io" className="text-primary hover:underline">mockapi.tensorify.io</a>, and <a href="https://plugins.tensorify.io" className="text-primary hover:underline">plugins.tensorify.io</a> (collectively, the &ldquo;Site&rdquo;) is a copyrighted work belonging to ALPHAWOLF VENTURES, INC. (&ldquo;Company&rdquo;, &ldquo;us&rdquo;, &ldquo;our&rdquo;, and &ldquo;we&rdquo;). Certain features of the Site may be subject to additional guidelines, terms, or rules, which will be posted on the Site in connection with such features. All such additional terms, guidelines, and rules are incorporated by reference into these Terms.
            </p>
